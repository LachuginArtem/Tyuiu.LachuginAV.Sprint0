...
using Tyuiu.LachuginAV.Sprint0.Task7.V0.Lib;

namespace Tyuiu.LachuginAV.Sprint0.Task7.V0
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнил: Лачугин А.В | АСОиУБ-23-3";
            Console.WriteLine("***************************************************************************");
